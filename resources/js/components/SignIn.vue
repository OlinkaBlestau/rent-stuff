    ...
    <div class="d-flex col-12 form-signin container justify-content-center align-content-center mt-5">
        <form action="/signInService" method="post">
            ...
            <div class="form-group mt-4">
                ...
                <input v-model="address" type="text" :class="'form-control ' + formErrors.address" id="address" name="address" placeholder="Address">
            </div>
...
export default {
    ...
    watch: {
        ...
        address() {
            ...
            if (this.address.length < 3 || this.address.length > 32) {
